        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              ...
              <div class="add">
                <!--加入购物车，进行路由跳转之前，发请求把购买的产品信息通过
                请求的形式通知服务器，服务器进行相应的存储 -->
...
export default {
  ...
  computed: {
    ...
    skuImageList() {
      // 需要考虑到服务器数据没那么快回来skuInfo会是undefined，skuImageList需要先传个空数组
  ...
  methods: {
    ...
    async addShopcar() {
      ...
      try {
        ...
        // 请求成功再进行路由跳转，以及携带产品信息给下一级的路由组件
        // 由于skuInfo是object，数据比较复杂，采用sessionStorage
